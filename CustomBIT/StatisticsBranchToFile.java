...
public class StatisticsBranchToFile
{
	String class_name_;
	String method_name_;
	int pc_;
	...
	public StatisticsBranchToFile(String class_name, String method_name, int pc)
		{
	...
	public void print(PrintWriter writer)
		{
			writer.println(class_name_ + '\t' + method_name_ + '\t' + pc_ + '\t' + taken_ + '\t' + not_taken_);
		}
